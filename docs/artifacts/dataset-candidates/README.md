...
| [gt_check-cuda-100k.json](yfcc10m/gt_check-cuda-100k.json) | **E1's gate on the A100, 2026-09-06**: `yfcc_check_gt --device cuda` over all 100,000 queries — 100,000 id-exact, 0 tie-equivalent, 0 mismatched, `max_abs_distance_error = 0.0`, 1276 s. |
