...
#
#   bash docs/artifacts/evaluation-harness-v2/c4_gate_run.sh
#
...
C4=${C4:-$ROOT/docs/artifacts/evaluation-harness-v2/c4}
OUT=${OUT:-$C4/results}
...
for stage in $STAGES; do
  ...
  case $stage in
    ...
    gate)
      set +e
      python3 "$ROOT/docs/artifacts/evaluation-harness-v2/c4_gate.py" \
