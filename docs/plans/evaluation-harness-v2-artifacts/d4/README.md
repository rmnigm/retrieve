...
cp ../docs/plans/evaluation-harness-v2-artifacts/c4/results/filter/*.jsonl /tmp/d4/filter/
cat ../docs/plans/evaluation-package-layout-artifacts/c5/results/filter/goodreads-d128.jsonl \
    >> /tmp/d4/filter/goodreads-d128.jsonl
cat ../docs/plans/evaluation-package-layout-artifacts/c5/results/filter/goodreads-d128.samples.jsonl \
