...
(``torch.equal`` on ids and scores). Results go to ``results.json`` next to the tensors.
    ...
    cd retrieve && PYTHONPATH=. python ../docs/plans/library-api-refactor-artifacts/l1/premove_check.py capture --dir <dir>
    cd retrieve && PYTHONPATH=. python ../docs/plans/library-api-refactor-artifacts/l1/premove_check.py compare --dir <dir>
"""
