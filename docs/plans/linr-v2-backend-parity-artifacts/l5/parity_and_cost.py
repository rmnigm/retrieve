...
D. The compiled PTX's arithmetic op counts (and the PTX itself, `--ptx-out`).
    ...
    cd /workspace/wt/l5/retrieve && flock /workspace/gpu.lock uv run --no-sync python \
        ../docs/plans/linr-v2-backend-parity-artifacts/l5/parity_and_cost.py \
        --out ../docs/plans/linr-v2-backend-parity-artifacts/l5/parity_and_cost.json \
        --ptx-out ../docs/plans/linr-v2-backend-parity-artifacts/l5/fused_masked_knn_topk_fp32.ptx
"""
