...
| gate | state | notes |
|---|---|---|
| Library suite (`retrieve/tests`, GPU, `official` extra installed) | **green**, 653 passed at the last full run | tolerances untouched; see [testing](system/testing.md) |
| Triton vs reference ops, every parity file | **bit-exact** | ids equal up to ties where the op returns a top-k |
