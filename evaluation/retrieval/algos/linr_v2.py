...
materialized. ``PrefilterKNNTriton`` then rescores those P candidates at
fp32. ``filter_mod`` is required (no unfiltered mode) — that's the whole
...
from retrieve import PrefilterKNNTriton
...
class LinrV2Algo:
    ...
    def __init__(
        ...
        *,
        ...
        self.idx = PrefilterKNNTriton(k=k).to(item_embs.device)
