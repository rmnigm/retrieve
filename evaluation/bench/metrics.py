...
means equal the old per-row means to 1e-9. ``training/evaluate.py`` keeps its own frozen
recall / ndcg (plan V D5); ``tests/training/test_encode.py`` pins the two to agree.
"""
