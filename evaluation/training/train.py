...
Usage (``train sasrec …``), the config surface, and what a finished run writes out:
...
@click.option(
    ...
    default=None,
    help="load every hyperparameter from this JSON (GSASRecConfig.load); other flags are "
    "ignored except --resume",
)
